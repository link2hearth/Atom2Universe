...
class CompleteEvaluator : Evaluator() {
    ...
    private val MOBILITY = arrayOf(intArrayOf(), intArrayOf(), intArrayOf(
        oe(-12, -16),
        oe(2, 2),
        oe(5, 7),
        oe(7, 9),
    ...
    // Attacks
    private val PAWN_ATTACKS = intArrayOf(0, 0, oe(11, 15), oe(12, 16),
        oe(17, 23),
        oe(19, 25), 0)
    private val MINOR_ATTACKS = intArrayOf(0, oe(3, 5), oe(7, 9),
        oe(7, 9),
        oe(10, 14),
        oe(11, 15), 0) // Minor piece attacks to pawn undefended pieces
    private val MAJOR_ATTACKS = intArrayOf(0, oe(2, 2), oe(3, 4),
        oe(3, 4),
        oe(5, 6),
        oe(5, 7), 0) // Major piece attacks to pawn undefended pieces

    private val HUNG_PIECES =
        oe(16, 25) // Two or more pieces of the other side attacked by inferior pieces
    ...
    private val PAWN_CANDIDATE = intArrayOf(0, oe(10, 13), oe(10, 13),
        oe(14, 18),
        oe(22, 28),
        oe(34, 43),
        oe(50, 63), 0)
    private val PAWN_PASSER = intArrayOf(0, oe(20, 25), oe(20, 25),
        oe(28, 35),
        oe(44, 55),
        oe(68, 85),
        oe(100, 125), 0)
    private val PAWN_PASSER_OUTSIDE = intArrayOf(0, 0, 0, oe(2, 3), oe(7, 9),
        oe(14, 18),
        oe(24, 30), 0)
    private val PAWN_PASSER_CONNECTED = intArrayOf(0, 0, 0, oe(3, 3), oe(8, 8),
        oe(15, 15),
        oe(25, 25), 0)
    private val PAWN_PASSER_SUPPORTED = intArrayOf(0, 0, 0, oe(6, 6),
        oe(17, 17),
        oe(33, 33),
        oe(55, 55), 0)
    private val PAWN_PASSER_MOBILE = intArrayOf(0, 0, 0, oe(2, 2), oe(6, 6),
        oe(12, 12),
        oe(20, 20), 0)
    private val PAWN_PASSER_RUNNER = intArrayOf(0, 0, 0, oe(6, 6), oe(18, 18),
        oe(36, 36),
        oe(60, 60), 0)

    private val PAWN_PASSER_OTHER_KING_DISTANCE = intArrayOf(0, 0, 0, oe(0, 2),
        oe(0, 6),
        oe(0, 12),
        oe(0, 20), 0)
    private val PAWN_PASSER_MY_KING_DISTANCE = intArrayOf(0, 0, 0, oe(0, 1),
        oe(0, 3),
        oe(0, 6),
        oe(0, 10), 0)

    private val PAWN_SHIELD_CENTER = intArrayOf(0, oe(55, 0), oe(41, 0),
        oe(28, 0),
        oe(14, 0), 0, 0, 0)
    private val PAWN_SHIELD = intArrayOf(0, oe(35, 0), oe(26, 0),
        oe(18, 0),
        oe(9, 0), 0, 0, 0)
    private val PAWN_STORM_CENTER = intArrayOf(0, 0, 0, oe(8, 0), oe(15, 0),
        oe(30, 0), 0, 0)
    private val PAWN_STORM = intArrayOf(0, 0, 0, oe(5, 0), oe(10, 0),
        oe(20, 0), 0, 0)

    private val PAWN_BLOCKADE =
        oe(5, 0) // Penalty for pawns in [D,E] in the initial square blocked by our own pieces
    ...
    private val BISHOP_MY_PAWNS_IN_COLOR_PENALTY =
        oe(2, 4) // Penalty for each of my pawns in the bishop color (Capablanca rule)
    ...
    private val ROOK_7 =
        oe(7, 10) // Rook 5, 6 or 7th rank attacking a pawn in the same rank not defended by pawn
    private val ROOK_TRAPPED_PENALTY = intArrayOf(
        oe(40, 0), oe(30, 0),
        oe(20, 0),
        oe(10, 0)
    ) // Penalty by number of mobility squares
    ...
    private val PIECE_ATTACKS_KING = intArrayOf(0, 0, oe(30, 0), oe(20, 0),
        oe(40, 0),
        oe(80, 0)
    )
    ...
    private val pawnPcsq = intArrayOf(
        oe(-18, 4), oe(-6, 2),
        oe(0, 0),
        oe(6, -2),
        oe(6, -2),
    ...
    private val knightPcsq = intArrayOf(
        oe(-27, -22), oe(-17, -17),
        oe(-9, -12),
        oe(-4, -9),
        oe(-4, -9),
    ...
    private val bishopPcsq = intArrayOf(
        oe(-7, 0), oe(-8, -1),
        oe(-11, -2),
        oe(-13, -2),
        oe(-13, -2),
    ...
    private val rookPcsq = intArrayOf(
        oe(-4, 0), oe(0, 0),
        oe(4, 0),
        oe(8, 0),
        oe(8, 0),
    ...
    private val queenPcsq = intArrayOf(
        oe(-9, -15), oe(-6, -10),
        oe(-4, -8),
        oe(-2, -7),
        oe(-2, -7),
    ...
    private val kingPcsq = intArrayOf(
        oe(34, -58), oe(39, -35),
        oe(14, -19),
        oe(-6, -13),
        oe(-6, -13),
