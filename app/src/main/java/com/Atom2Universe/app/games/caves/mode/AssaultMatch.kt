 ...
 *
 * Une manche = abattre toutes les cibles avant la fin du chrono. Entre deux manches, une courte
 * pause laisse le temps de lire le bilan. Le score s'additionne d'une manche à l'autre.
 */
internal class AssaultMatch(
    ...
    enum class RoundEnd { CLEARED, TIME_UP }
    ...
    /**
     * Une cible vient de tomber, abattue d'un tir à la tête si [headshot].
     * Renvoie [Event.ROUND_ENDED] si c'était la dernière de la manche.
     */
