 ...
 *
 * - [radiusKm]       rayon moyen adopté ; valeurs stellaires dépendantes des modèles.
...
object CosmicScaleData {
    ...
    private fun star(
        ...
        spectralType: String, massSolar: Double
    ) = CosmicBody(
        id = id, nameRes = nameRes, kind = BodyKind.STAR,
        radiusKm = solarRadii * R_SUN_KM, textureAsset = null,
        tintColor = if (id == "sun") 0xFFFFFAF2.toInt() else tempToRgb(temperatureK.toDouble()),
    ...
    private fun blackHole(
        ...
        radiusKm = massSolar * RS_PER_SOLAR_MASS_KM, textureAsset = null,
    ...
    val bodies: List<CosmicBody> = listOf(
        ...
        planet("neptune", R.string.cosmic_name_neptune, BodyKind.GAS, 24_622.0, "textures/planets/neptune.jpg", 0xFF96C4D1.toInt()),
        planet("uranus", R.string.cosmic_name_uranus, BodyKind.GAS, 25_362.0, "textures/planets/uranus.jpg", 0xFFA1CCD1.toInt()),
        ...
        // ── Étoiles (photosphères illustrées selon température et famille stellaire) ──
        star("sun", R.string.cosmic_name_sun, 1.0, 5_772, "G2V", 1.0),
        star("sirius", R.string.cosmic_name_sirius, 1.713, 9_940, "A1V", 2.06),
        ...
        // ── Trous noirs (rayon = horizon de Schwarzschild, horizon non tournant schématique) ──
