...
function collectDomElements() {
  ...
  infoStarsWarTop1Value: document.getElementById('infoStarsWarTop1Value'),
  infoStarsWarTop2Value: document.getElementById('infoStarsWarTop2Value'),
  infoStarsWarTop3Value: document.getElementById('infoStarsWarTop3Value'),
