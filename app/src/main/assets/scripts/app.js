...
function collectDomElements() {
  ...
  infoStarsWarEasyTop1Value: document.getElementById('infoStarsWarEasyTop1Value'),
  infoStarsWarEasyTop2Value: document.getElementById('infoStarsWarEasyTop2Value'),
  infoStarsWarEasyTop3Value: document.getElementById('infoStarsWarEasyTop3Value'),
  infoStarsWarHardTop1Value: document.getElementById('infoStarsWarHardTop1Value'),
  infoStarsWarHardTop2Value: document.getElementById('infoStarsWarHardTop2Value'),
  infoStarsWarHardTop3Value: document.getElementById('infoStarsWarHardTop3Value'),
