...
function collectDomElements() {
  ...
  infoSurvivorLikeTimeValue: document.getElementById('infoSurvivorLikeTimeValue'),
  infoSurvivorLikeLevelValue: document.getElementById('infoSurvivorLikeLevelValue'),
  infoSurvivorLikeHeroMageValue: document.getElementById('infoSurvivorLikeHeroMageValue'),
  infoSurvivorLikeHeroRobotValue: document.getElementById('infoSurvivorLikeHeroRobotValue'),
  infoSurvivorLikeHeroGhostValue: document.getElementById('infoSurvivorLikeHeroGhostValue'),
  infoSurvivorLikeHeroChatNoirValue: document.getElementById('infoSurvivorLikeHeroChatNoirValue'),
  infoSurvivorLikeHeroSkeletonValue: document.getElementById('infoSurvivorLikeHeroSkeletonValue'),
  infoSurvivorLikeHeroVortexValue: document.getElementById('infoSurvivorLikeHeroVortexValue'),
