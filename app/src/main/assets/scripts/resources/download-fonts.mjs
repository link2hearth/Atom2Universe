...
const FONT_CSS_URL =
  'https://fonts.googleapis.com/css2?family=Audiowide&family=Cinzel:wght@400&family=Orbitron:wght@400;600;700&family=Seven+Segment&family=VT323&display=swap';
