...
Les transitions se font par paliers de palette, pas par interpolation RGB continue.
...
Le résultat utilise 225 couches de 32 × 32 RGBA, soit environ 900 Kio de pixels
GPU hors structures de gestion et copies UI. Les variantes climatiques sont
partagées ; le climat est calculé au plus une fois par colonne contenant de la
végétation lors de la construction du maillage, jamais à chaque image.
