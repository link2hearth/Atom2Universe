...
function getOptionsWelcomeCardCopy() {
  ...
  if (api && typeof api.getResource === 'function') {
    const resource = api.getResource('index.sections.options.welcomeCard');
...
function renderOptionsWelcomeContent() {
  ...
  if (elements.optionsWelcomeTitle) {
    ...
    const titleText = copy && typeof copy.title === 'string' && copy.title.trim()
      ? copy.title.trim()
      : translateOrDefault('index.sections.options.welcomeCard.title', fallbackTitle);
  ...
  if (elements.optionsWelcomeIntro) {
    ...
    if (!paragraphs.length) {
      const translatedIntro = translateOrDefault('index.sections.options.welcomeCard.intro', '');
      if (translatedIntro) {
