// Auto-generated embedded translation resources.
// This file allows the app to work when fetch() cannot load the JSON bundles (e.g. file:// protocol).
(function initEmbeddedI18n(global) {
  const data = {
    "fr": {
      "index": {
        "meta": {
          "title": "Atom to Univers"
        },
        "navigation": {
        ...
        "sections": {
          ...
          "shop": {
            "title": "Boutique quantique"
          },
          "gacha": {
            "title": "Portail de tirage cosmique",
            "toggleAria": "Basculer le mode de tirage (actuel : Tirage x1)",
          ...
          "arcade": {
            ...
            "canvasAria": "Zone de jeu Particules",
            "overlay": {
        ...
        "table": {
          ...
          "info": {
            ...
            "aps": {
              "title": "Production automatique (APS)",
              "subtitle": "Synthèse par seconde",
              "aria": "Détail du calcul APS"
            },
            "apc": {
              "title": "Production manuelle (APC)",
              "subtitle": "Atomes par clic",
              "aria": "Détail du calcul APC"
            },
            "progress": {
              "title": "Progression",
              "subtitle": "Session & globale",
              "session": {
                "title": "Session",
                "atoms": "Atomes gagnés",
            ...
            "shop": {
              "title": "Bonus boutique",
              "subtitle": "Effets cumulés du magasin"
            },
            "elements": {
              "title": "Bonus éléments",
          ...
          "goals": {
            ...
            "intro": "Surveillez vos succès galactiques et débloquez des bonus permanents.",
            "empty": "Aucun trophée complété pour le moment. Terminez des objectifs pour les afficher ici."
          },
          "bigbang": {
            "title": "Big Bang",
            "description": "A venir"
          ...
          "options": {
            ...
            "language": {
              ...
              "note": "La modification s’applique immédiatement."
            },
            "music": {
              "title": "Musique",
              "track": "Piste en lecture",
              "loading": "Chargement...",
              "volume": "Volume",
              "note": "La musique démarre automatiquement après votre première interaction."
            },
            "brickSkin": {
              "title": "Skin des briques",
          ...
          "devkit": {
            "title": "DevKit quantique",
            "close": "Fermer le DevKit",
            "intro": "Outils de triche pour expérimentations rapides. Les changements sont immédiats.",
            "resources": {
              "title": "Ressources",
              "giveAtoms": "Donner des atomes",
              "atomsPlaceholder": "ex : 1e9",
              "add": "Ajouter",
              "increaseAuto": "Augmenter les APS plats",
              "autoPlaceholder": "ex : 250000",
              "increase": "Augmenter",
            ...
            "modes": {
              ...
              "shop": "Magasin gratuit : désactivé",
              "gacha": "Tirages gratuits : désactivés",
              "note": "Les modes restent actifs tant que la session est ouverte (raccourci F9)."
            },
            "footer": "Appuyez sur F9 pour ouvrir ou fermer le DevKit."
          }
        }
      },
      "config": {
        "shop": {
          "buildings": {
            ...
            "parallelUniverse": {
              ...
              "effect": "Production passive : +100 000 000 000 000 APS par niveau."
            },
            "omniverseLibrary": {
        ...
        "arcade": {
          "particules": {
            "graviton": {
              "detection": "Graviton détecté !",
              "dissipate": "Le graviton s’est dissipé…",
              "capture": "Graviton capturé !"
            },
            "lingerBonus": {
          ...
          "sudoku": {
            "status": {
              ...
              "mistakes": "Cases incorrectes : {count}.",
              "showMistakes": "Afficher les cases incorrectes",
              "hideMistakes": "Masquer les cases incorrectes",
      ...
      "scripts": {
        ...
        "app": {
          ...
          "trophies": {
            "unlocked": "Trophée débloqué : {name} !"
          },
          "devkit": {
            "invalidAtoms": "Valeur d’atome invalide.",
            "atomsAdded": "DevKit : +{amount} atomes",
            "invalidAps": "Bonus APS invalide.",
            "apsAdded": "DevKit : APS +{amount}",
            "noApsToReset": "Aucun bonus APS à réinitialiser.",
            "apsReset": "DevKit : bonus APS remis à zéro",
            "invalidTickets": "Nombre de tickets invalide.",
            "ticketAdded": {
            ...
            "elementsAdded": "DevKit : {count} éléments ajoutés à la collection !",
            "collectionComplete": "La collection était déjà complète.",
            "freeShopEnabled": "DevKit : magasin gratuit activé",
            "freeShopDisabled": "DevKit : magasin gratuit désactivé",
            "freeGachaEnabled": "DevKit : tirages gratuits activés",
            "freeGachaDisabled": "DevKit : tirages gratuits désactivés",
            "infoPageUnlocked": "DevKit : page Infos débloquée !",
            "infoPageAlready": "Page Infos déjà débloquée."
          },
          "shop": {
          ...
          "music": {
            ...
            "nowPlaying": "Lecture : {name}"
          },
          "reset": {
            "keyword": "RESET",
            "cancelled": "Réinitialisation annulée",
            "invalid": "Mot de confirmation incorrect",
            "done": "Progression réinitialisée"
          },
          "bigBangToggle": {
            "shown": "Bouton Big Bang affiché",
            "hidden": "Bouton Big Bang masqué"
          },
          "metaux": {
            "chronoBonus": "Chrono +{value} s",
            "multiBonus": "Multi +{value}",
            "toast": "Métaux : {details}",
            "unavailable": "Forge indisponible pour le moment.",
            "gameInProgress": "Une partie est déjà en cours. Terminez-la avant de relancer.",
          ...
          "offline": {
            "progressAtoms": "Progression hors ligne : +{amount} atomes",
            "tickets": "Tickets hors ligne : +{count} {unit}"
          },
          "offlineTickets": {
        ...
        "gacha": {
          ...
          "fusion": {
            "empty": "Aucune recette de fusion disponible",
        ...
        "appData": {
          ...
          "milestones": {
            ...
            "overclock": "Atteignez {amount} atomes pour accéder aux surcadences.",
            "nextEra": "Accumulez {amount} atomes pour préparer la prochaine ère."
          },
          "trophies": {
            "millionAtoms": {
        ...
        "gameData": {
          ...
          "categories": {
            ...
            "alkalineEarthMetal": "métal alcalino-terreux",
            "transitionMetal": "métal de transition",
            "postTransitionMetal": "métal pauvre",
        ...
        "particules": {
          "graviton": {
            "detected": "Graviton détecté !",
            "dissipated": "Le graviton s’est dissipé…",
            "captured": "Graviton capturé ! Ticket spécial +1"
          },
          "combos": {
            "bonusPrefix": "Bonus: ",
            "quarkPrefix": "Combo quark ! "
          ...
          "ui": {
            ...
            "levelCleared": {
              ...
              "speedBonus": " Bonus vitesse : +{bonus} !"
            },
            "gameOver": {
    ...
    "en": {
      "index": {
        ...
        "sections": {
          ...
          "gacha": {
            "title": "Cosmic draw portal",
            "toggleAria": "Toggle draw mode (current: Single draw)",
          ...
          "arcade": {
            ...
            "canvasAria": "Particles play area",
            "overlay": {
        ...
        "table": {
          ...
          "info": {
            ...
            "aps": {
              "title": "Automatic production (APS)",
              "subtitle": "Synthesis per second",
              "aria": "APS breakdown"
            },
            "apc": {
              "title": "Manual production (APC)",
              "subtitle": "Atoms per click",
              "aria": "APC breakdown"
            },
            "progress": {
              "title": "Progress",
              "subtitle": "Session & global",
              "session": {
                "title": "Session",
                "atoms": "Atoms gained",
            ...
            "shop": {
              "title": "Shop bonuses",
              "subtitle": "Combined store effects"
            },
            "elements": {
              "title": "Element bonuses",
          ...
          "goals": {
            "title": "Objectives & trophies",
            "intro": "Track your galactic achievements and unlock permanent bonuses.",
            "empty": "No trophy completed yet. Finish objectives to display them here."
          },
          "bigbang": {
            "title": "Big Bang",
          ...
          "devkit": {
            "title": "Quantum DevKit",
            "close": "Close the DevKit",
            "intro": "Cheat tools for rapid experimentation. Changes apply instantly.",
            "resources": {
              "title": "Resources",
              "giveAtoms": "Give atoms",
              "atomsPlaceholder": "e.g. 1e9",
              "add": "Add",
              "increaseAuto": "Increase flat APS",
              "autoPlaceholder": "e.g. 250000",
              "increase": "Increase",
            ...
            "modes": {
              ...
              "shop": "Free shop: off",
              "gacha": "Free draws: off",
              "note": "Modes remain active while the session stays open (shortcut F9)."
            },
            "footer": "Press F9 to open or close the DevKit."
          }
        }
      },
      "config": {
        ...
        "trophies": {
          "presets": {
            "scaleHumanCell": {
              ...
              "flavor": "the equivalent of an “average” human cell"
            },
            "scaleSandGrain": {
              "name": "Scale: grain of sand",
              "flavor": "the mass of a grain of sand (~1 mm)"
            },
            "scaleAnt": {
              "name": "Scale: ant",
            ...
            "scaleWaterDrop": {
              "name": "Scale: drop of water",
              "flavor": "the number of atoms in a 0.05 mL drop of water"
            },
            "scalePaperclip": {
            ...
            "scaleSmartphone": {
              ...
              "flavor": "as many as a modern smartphone (~180 g)"
            },
            "scaleWaterLitre": {
              "name": "Scale: liter of water",
              "flavor": "equivalent to one liter of water"
            },
            "scaleHuman": {
            ...
            "scalePiano": {
              "name": "Scale: piano",
              "flavor": "equal to a piano (~450 kg)"
            },
            "scaleCar": {
              "name": "Scale: compact car",
              "flavor": "as much as a compact car (~1.3 t)"
            },
            "scaleElephant": {
              "name": "Scale: elephant",
              "flavor": "equal to an elephant (~6 t)"
            },
            "scaleBoeing747": {
              "name": "Scale: Boeing 747",
              "flavor": "as much as a Boeing 747"
            },
            "scalePyramid": {
              "name": "Scale: Great Pyramid",
              "flavor": "atomic mass of the Great Pyramid of Khufu"
            },
            "scaleAtmosphere": {
              "name": "Scale: Earth's atmosphere",
              "flavor": "equal to the entire Earth's atmosphere"
            },
            "scaleOceans": {
              "name": "Scale: Earth's oceans",
              "flavor": "as much as all Earth's oceans"
            },
            "scaleEarth": {
              "name": "Scale: Earth",
              "flavor": "equal to the atomic mass of planet Earth"
            },
            "scaleSun": {
              "name": "Scale: Sun",
            ...
            "scaleLocalGroup": {
              ...
              "flavor": "as much as the Local Group of galaxies"
            },
            "scaleVirgoCluster": {
              "name": "Scale: Virgo supercluster",
              "flavor": "equal to the Virgo supercluster"
            },
            "scaleObservableUniverse": {
              "name": "Scale: observable universe",
              "flavor": "reach the estimated number of atoms in the observable universe"
            }
          },
          "reward": {
        ...
        "arcade": {
          "particules": {
            "graviton": {
              "detection": "Graviton detected!",
              "dissipate": "The graviton has dissipated...",
              "capture": "Graviton captured!"
            },
            "lingerBonus": {
              "message": "Bonus multiball!"
            },
            "combos": {
              "bonusPrefix": "Bonus: ",
              "quarkPrefix": "Quark combo! "
            },
            "powerUps": {
              "labels": {
                "extend": "Extended paddle",
                "multiball": "Multiball",
                "laser": "Laser shot",
                "speed": "Acceleration",
                "floor": "Lower shield"
          ...
          "sudoku": {
            "status": {
              ...
              "mistakes": "Incorrect cells: {count}.",
              "showMistakes": "Show incorrect cells",
              "hideMistakes": "Hide incorrect cells",
      ...
      "scripts": {
        ...
        "app": {
          "brickSkins": {
            "applied": {
              "original": "Original skin applied.",
              "metallic": "Metallic skin applied.",
          ...
          "trophies": {
            "unlocked": "Trophy unlocked: {name}!"
          },
          "devkit": {
            "invalidAtoms": "Invalid atom value.",
            "atomsAdded": "DevKit: +{amount} atoms",
            "invalidAps": "Invalid APS bonus.",
            "apsAdded": "DevKit: APS +{amount}",
            "noApsToReset": "No APS bonus to reset.",
            "apsReset": "DevKit: APS bonus reset",
            "invalidTickets": "Invalid ticket amount.",
            "ticketAdded": {
            ...
            "elementsAdded": "DevKit: {count} elements added to the collection!",
            "collectionComplete": "The collection was already complete.",
            "freeShopEnabled": "DevKit: free shop enabled",
            "freeShopDisabled": "DevKit: free shop disabled",
            "freeGachaEnabled": "DevKit: free draws enabled",
            "freeGachaDisabled": "DevKit: free draws disabled",
            "infoPageUnlocked": "DevKit: Info page unlocked!",
            "infoPageAlready": "Info page already unlocked."
          },
          "shop": {
          ...
          "reset": {
            ...
            "invalid": "Incorrect confirmation word",
            "done": "Progress reset"
          },
          "bigBangToggle": {
            "shown": "Big Bang button shown",
            "hidden": "Big Bang button hidden"
          },
          "metaux": {
            "chronoBonus": "Timer +{value} s",
            "multiBonus": "Multiplier +{value}",
            "toast": "Metals: {details}",
            "unavailable": "Forge unavailable at the moment.",
            "gameInProgress": "A game is already in progress. Finish it before starting a new one.",
          ...
          "offline": {
            "progressAtoms": "Offline progress: +{amount} atoms",
            "tickets": "Offline tickets: +{count} {unit}"
          },
          "offlineTickets": {
            "ticketSingular": "ticket",
            "ticketPlural": "tickets"
        ...
        "gacha": {
          "rarities": {
            "commun": {
              "label": "Cosmic Common",
              "description": "Fundamental bricks found across most nebulae."
            },
            "essentiel": {
              "label": "Planetary Essential",
              "description": "Elements abundant on rocky worlds and habitable atmospheres."
            },
            "stellaire": {
              "label": "Stellar Forge",
              "description": "Alloys shaped in stellar cores and scattered by supernovae."
            },
            "singulier": {
              "label": "Mineral Singularity",
              "description": "Sought-after crystals rarely concentrated in the same place."
            },
            "mythique": {
              "label": "Quantum Myth",
              "description": "Legendary elements with extreme, elusive properties."
            },
            "irreel": {
              "label": "Unreal",
              "description": "Artificial syntheses born only inside accelerators."
            }
          },
          "featured": {
            "today": "Today",
          ...
          "fusion": {
            "empty": "No fusion recipes available",
        ...
        "appData": {
          ...
          "milestones": {
            ...
            "overclock": "Reach {amount} atoms to access overclocking.",
            "nextEra": "Accumulate {amount} atoms to prepare the next era."
          },
          "trophies": {
            "millionAtoms": {
              "name": "Million Rush",
        ...
        "particules": {
          "graviton": {
            "detected": "Graviton detected!",
            "dissipated": "The graviton dissipated…",
            "captured": "Graviton captured! Special ticket +1"
          },
          "combos": {
            "bonusPrefix": "Bonus: ",
            "quarkPrefix": "Quark combo! "
          ...
          "ui": {
            ...
            "pause": {
              "message": "Game paused. Tap the paddle to continue.",
              "button": "Resume"
            },
            "lifeLost": {
              "message": "Particle lost! Tap the paddle to continue.",
              "button": "Resume"
            },
            "levelCleared": {
              "template": "Level {level} cleared!{reward}",
              "button": "Continue",
              "reward": " {reward} obtained!",
              "noReward": " No tickets this time.",
              "speedBonus": " Speed bonus: +{bonus}!"
            },
            "gameOver": {
              "withTickets": "Game over! Tickets earned: {tickets}{bonus}.",
              "withoutTickets": "Game over! No tickets this time.",
              "button": "Play again"
            },
            "hud": {
              "ticketSingular": "ticket",
              "ticketPlural": "tickets",
              "bonusTicketSingular": "Mach3 ticket",
              "bonusTicketPlural": "Mach3 tickets"
            },
            "overlay": {
