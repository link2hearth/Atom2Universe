...
public class MidiDriver
{
     ...
     * Use this to force audio output to a specific device (e.g., built-in speaker)
     * even when other audio devices (like USB MIDI keyboards with audio) are connected.
     *
     * @param deviceId device ID from AudioDeviceInfo.getId(), or -1 for default
     * @return true for success
     */
    public native boolean setOutputDevice(int deviceId);
